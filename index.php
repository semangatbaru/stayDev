...
<html lang="en">
    ...
    <body>
        ...
        <div id="home">
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    <!-- Start first slide -->
                    <div class="da-slide" >
                        <h2 class="fittext2">Welcome to Staydev !</h2>
                        <h4>Software House</h4>
                        <p class="oblique">Melayani pembuatan aplikasi berbasis website, dekstop dan android. Bekerja dengan hati dan mengutamakan kepuasan pelanggan. Profesional sebagai teaem dan transparansi pembuatan sangat ditekankan dalam sistem yang akan kita bangun atau kembangkan.</p>
                    ...
                    <div class="da-slide">
                        <h2>Let's Join Us !</h2>
                        <h4>Easy to use</h4>
                        <p>Manajemen dengan sistem kekeluargaan agar konsumen bisa konsultasi dengan nyaman dengan pihak kami untuk capain projek yang diinginkan konsumen , manajemen maksimal, berkerja sepenuh hati untuk membangun sistem informasi.</p>
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                    ...
                    <!-- Start third slide -->
                    <div class="da-slide">
                        <h2>A Better Revolution </h2>
                        <h4>Customizable</h4>
                        <p>Permintaan konsumen yang akan kami utamakan, proses menjadi tolak ukur pembuatan kita bukan hanya soal hasil, budget juga bisa disesuaikan tergantung kerumitan sistem yang akan dibuat.</p>
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
        ...
        <div class="section primary-section" id="service">
            <div class="container">
                ...
                <div class="title">
                    ...
                    <p>Berikut apa saja yang bisa kami bantu untuk anda.</p>
            ...
            <div class="container">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="filter" data-filter="android">
                        <a href="#noAction">Android</a>
                    </body>
                    <li class="filter" data-filter="photo">
                        <a href="#noAction">Network</a>
                    </li>
                    <li class="filter" data-filter="identity">
                        <a href="#noAction">Design</a>
                    </li>
                </ul>
                ...
                <div id="single-project">
                    <div id="slidingDiv" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="images/Portf01.png" alt="project 1" />
                        </div>
                        <div class="span6">
                    ...
                    <div id="slidingDiv3" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="images/Portf04.png" alt="project 4">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv8" class="toggleDiv row-fluid single-project">
                            <div class="span6">
                                <img src="images/Portfolio10.png" alt="project 10">
                            </div>
                            <div class="span6">
                                <div class="project-description">
                                    <div class="project-title clearfix">
            ...
            <div class="container">
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="images/toriq.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
       ...
       <!--  <div id="price" class="section secondary-section">
        ...
        <div class="scrollup">
            <a target="_blank" href="http://bit.ly/hubungistaydev">
                <img src="https://img.icons8.com/color/240/000000/whatsapp.png">    
            </a>
        </div>
        <!-- ScrollUp button end -->
        <!-- Include javascript -->
